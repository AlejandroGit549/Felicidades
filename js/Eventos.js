...
function MostrarMensajeFelicidades(){
    ...
    En este día, celebro no solo el día de tu nacimiento, sino también la persona asombrosa en la que te has convertido. <br>Eres un recordatorio constante de la belleza y la bondad que existen en el mundo, y no puedo sentirme más agradecido por tenerte en mi vida.
    ...
    [ASM]`,
    footer: '<a href="https://youtu.be/dH7_By3Y2i0" target="_blank">Ver<> <a href="listado.html" target="_blank">Leer<>' })
}